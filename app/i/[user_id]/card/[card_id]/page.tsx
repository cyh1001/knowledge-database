    ...
    <div className="container mx-auto p-4">
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <Link href={`/i/${userId}/original/${card.original_text_id}`} className="link link-primary mb-4">
            查看原文
          </Link>
...
//         <div className="card-body">
//           <h2 className="card-title text-2xl font-bold mb-4">{card.title}</h2>
//           <Link href={`/i/${userId}/origin/${card.original_text_id}`} className="link link-primary mb-4">
//             View Original Text
//           </Link>
//           <div className="flex flex-col md:flex-row gap-4">
//             <div className="flex-1">
